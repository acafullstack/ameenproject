...
class MarkerPage extends StatefulWidget {
  List<Places> _placeMarker;
  MarkerPage(this._placeMarker);

  @override
  _MarkerPagePageState createState() => _MarkerPagePageState(this._placeMarker);
}

class _MarkerPagePageState extends State<MarkerPage> {

  Completer<GoogleMapController> controller = Completer();

  _MarkerPagePageState(this._placeMarker);
  ...
  _generateMarkers() async {
    Set<Marker> markers = Set();
    for(Places places in _placeMarker) {
...
//        markers: {newMarker, oldMarker},
  ...
  LatLng computeCentroid() {
    ...
    for (Places place in _placeMarker) {
